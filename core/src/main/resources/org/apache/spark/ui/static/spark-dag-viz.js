...
function drawCrossStageEdges(edges, svgContainer) {
  ...
  for (var i = 0; i < edges.length; i++) {
    ...
    var fromStageId = edges[i][2];
    connectRDDs(fromRDDId, toRDDId, fromStageId, edgesContainer, svgContainer);
  }
...
function connectRDDs(fromRDDId, toRDDId, fromStageId, edgesContainer, svgContainer) {
